...
def _appt_dict(a):
    return {
        ...
        'case_status':       getattr(a.visit_id, 'case_status', '') or '' if a.visit_id else '',
        'arrival_mode':      getattr(a.visit_id, 'arrival_mode', '') or '' if a.visit_id else '',
        'companion_name':    getattr(a.visit_id, 'companion_name', '') or '' if a.visit_id else '',
        'exit_status':       getattr(a.visit_id, 'exit_status', '') or '' if a.visit_id else '',
        'accident_rescuer_name':  getattr(a.visit_id, 'accident_rescuer_name', '') or '' if a.visit_id else '',
        'accident_car_number':    getattr(a.visit_id, 'accident_car_number', '') or '' if a.visit_id else '',
        'accident_location':      getattr(a.visit_id, 'accident_location', '') or '' if a.visit_id else '',
        'accident_rescuer_phone': getattr(a.visit_id, 'accident_rescuer_phone', '') or '' if a.visit_id else '',
        'referral_from':           getattr(a.visit_id, 'referral_from', '') or '' if a.visit_id else '',
        'referral_to':             getattr(a.visit_id, 'referral_to', '') or '' if a.visit_id else '',
