...
def _visit_dict(v, full=False):
    ...
    d = {
        ...
        'transfer_hospital_from': v.transfer_hospital_from or '',
        'transfer_hospital_to':   v.transfer_hospital_to or '',
...
def _visit_update_vals(body):
    ...
    str_fields = (
        ...
        'transfer_hospital_from', 'transfer_hospital_to',
...
class VisitController(http.Controller):
    ...
    def create(self, **kw):
        ...
        vals = {
            ...
            'transfer_hospital_from':  body.get('transfer_hospital_from', ''),
            'transfer_hospital_to':    body.get('transfer_hospital_to', ''),
